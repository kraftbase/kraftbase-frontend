...
const testimonials = [
  ...
  {
    content:
      "Nam sodales ut risus mollisultricies. Morbi volutpat lacus lectus, sit amet suscipit tellus eleifend nec. Sed elementum",
    author: "John Doe",
    designation: "Founder & CEO, Referwo",
    img: avatar1,
  },
...
function ClientTestimonials() {
  ...
  return (
    <div className="mx-auto my-40 max-w-[70%] max-2xl:max-w-[85%] max-md:max-w-[90%]">
      <p className="font-righteous text-9xl leading-tight text-black dark:text-white  max-[1042px]:text-7xl max-md:text-[55px] max-sm:text-[50px]">
        Client
      </p>
      <p className="ml-32 font-righteous text-9xl leading-tight text-[#7B5EA7] max-[1042px]:text-7xl  max-md:ml-16 max-md:text-[55px] max-sm:ml-2 max-sm:text-[50px]">
        Testimonials
      </p>
      <p className="w-[95%] max-w-[60%] font-righteous text-[24px] capitalize text-[#000000] dark:text-[#ffffff] max-2xl:max-w-[65%] max-md:max-w-[100%] max-md:text-[18px] max-sm:text-center ">
      ...
      <div className="mt-12 ">
        <div className="flex items-start justify-center">
          {testimonials.map((_, index) => (
            <div
              key={index}
              className={`m-2 h-[11px] w-[41px] cursor-pointer ${
            ...
            <SplideSlide className="!border-0" key={index}>
              <div className="mt-12 h-full">
                <div className="flex items-start justify-center gap-4 ">
                  <div className="">
                    <svg
                      className="light:invert-[1] h-[43px] w-[80px] max-md:h-[35px] max-md:w-[65px] max-sm:h-[32px] max-sm:w-[60px]"
                  ...
                  <div className="">
                    <p className="font-righteous text-[30px] leading-tight text-[#000000] dark:text-white max-md:text-[20px] ">
                      {el.content}
                    </p>
                  </div>
                </div>
                <div className="ml-32 mt-12 flex justify-start max-md:ml-16 max-sm:ml-2">
                  <div className="flex items-center justify-center gap-4 border-r-2  border-solid border-r-[#B5C0C9] pr-4">
                    <Image
                      src={avatar1}
                      ...
                      height={60}
                    />
                    <div className="font-righteous text-[15.125px] leading-6 dark:text-white">
                      <p>{el.author}</p>
                      <p>{el.designation}</p>
                    </div>
                  </div>
        ...
        <div className=" flex justify-end gap-2">
          ...
          >
            <svg
              className="h-[80px] w-[80px] max-md:h-[70px] max-md:w-[70px] max-sm:h-[60px] max-sm:w-[60px]"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 126 127"
              fill="none"
            >
          ...
          >
            <svg
              className="h-[80px] w-[80px] max-md:h-[65px] max-md:w-[65px] max-sm:h-[60px] max-sm:w-[60px]"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 126 127"
              fill="none"
            >

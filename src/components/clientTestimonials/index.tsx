...
function ClientTestimonials() {
  ...
  return (
    <div className="max-w-[70%] max-2xl:max-w-[85%] max-md:max-w-[90%] mx-auto my-40">
      <p className="font-righteous dark:text-white text-black text-9xl  max-md:text-[55px] max-sm:text-[50px] leading-tight">
        Client
      </p>
      <p className="ml-32 max-md:ml-16 max-sm:ml-2 text-[#7B5EA7] font-righteous  text-9xl max-md:text-[55px] max-sm:text-[50px] leading-tight">
        Testimonials
      </p>
      <p className="font-righteous dark:text-[#ffffff] text-[#000000] text-[24px] max-md:text-[18px] w-[95%] capitalize max-w-[60%] max-2xl:max-w-[65%] max-md:max-w-[100%] max-sm:text-center ">
            ...
            <SplideSlide className="!border-0" key={index}>
              <div className="mt-12 h-full">
                <div className="flex justify-center items-start gap-4 ">
                  <div className="">
                    <svg
                      className="light:invert-[1] w-[80px] max-md:w-[65px] max-sm:w-[60px] h-[43px] max-md:h-[35px] max-sm:h-[32px]"

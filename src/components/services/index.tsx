...
export default function ServicesSection() {
  ...
  // const cardViewport = { amount: "all", margin: "-162px 0px 0px 0px" };
  ...
  return (
    <div className="mx-auto my-16 flex max-w-[1080px] flex-col items-center justify-center overflow-hidden rounded-2xl bg-royalblue p-16 dark:bg-white max-xl:max-w-[85%] max-xl:p-10 max-md:max-w-[95%] max-md:p-6">
      <div className="relative">
        <div className="absolute left-60 top-40">
          <InfiniteRotation isClient={isClient}>
            <RoundedFlowerSvg width={250} fill="#F1561B" />
          </InfiniteRotation>
        </div>
      </div>
      <div className="text-center font-righteous text-[65px] uppercase leading-tight text-white dark:text-black max-md:text-[45px] max-sm:text-[35px]">
        Kraftbase can help you grow faster.
      </div>
      <div className="mt-8 font-righteous uppercase text-white dark:text-black">
      ...
      <div className="mt-10">
        <div className="w-full px-2 py-3 sm:mx-auto  sm:px-0">
          <div className="relative text-sm  text-gray-700 antialiased">
            ...
            <div className="absolute left-1/2 h-full w-[1px] -translate-x-1/2 transform bg-white dark:bg-black max-sm:left-1 sm:block"></div>

            {/* <!-- Left section, set by justify-start and sm:pr-8 --> */}
            <motion.div
              initial="offscreen"
              whileInView="onscreen"
              viewport={{ amount: "all", margin: "-162px 0px 0px 0px" }}
            >
              <div className="mt-6 sm:mb-12 sm:mt-0">
                <div className="flex flex-col items-center max-sm:ml-8 sm:flex-row">
                  <div className="mx-auto flex w-full items-center justify-start">
                    <div className="w-full sm:w-1/2 sm:pr-8">
                      <div className="flex flex-col gap-6 font-righteous text-white dark:text-black max-sm:items-center">
                        <svg
                          width="80"
                          // height="139"
                          viewBox="0 0 139 139"
                        ...
                        <div className="self-end text-lg uppercase max-sm:self-center">
                          View More
                        </div>
                      </div>
                    </div>
                  ...
                  <motion.div
                    ...
                    className="absolute left-1/2 flex h-8 w-8 -translate-x-1/2 -translate-y-4 transform items-center justify-center rounded-full border-2 border-white bg-royalblue font-bold text-white dark:border-black dark:bg-white dark:text-black max-sm:left-1 sm:translate-y-0"
                  >
                    1
                  </motion.div>
                </div>
            ...
            >
              <div className="mt-6 sm:mb-12 sm:mt-0">
                <div className="flex flex-col items-center max-sm:ml-8 sm:flex-row">
                  ...
                  <motion.div
                    variants={cardVariants}
                    className="absolute left-1/2 flex h-8 w-8 -translate-x-1/2 -translate-y-4 transform items-center justify-center rounded-full border-2 border-white bg-royalblue text-white dark:border-black dark:bg-white dark:text-black max-sm:left-1 sm:translate-y-0"
                  >
                    2
                  </motion.div>
                </div>
              ...
              <motion.div variants={cardVariants}>
                <div className="mt-6 sm:mb-12 sm:mt-0">
                  <div className="flex flex-col items-center max-sm:ml-8 sm:flex-row">
                    ...
                    <motion.div
                      variants={cardVariants}
                      className="absolute left-1/2 flex h-8 w-8 -translate-x-1/2 -translate-y-4 transform items-center justify-center rounded-full border-2 border-white bg-[#5A56EB] text-white dark:border-black dark:bg-white dark:text-black max-sm:left-1 sm:translate-y-0"
                    >
                      3
                    </motion.div>
                  </div>

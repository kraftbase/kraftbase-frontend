      ...
      <div className="relative">
        <div className="absolute left-60 top-40">
          <InfiniteRotation isClient={isClient}>
            <RoundedFlowerSvg width={250} fill="#E7E51E" />
          </InfiniteRotation>
        </div>
      </div>
          ...
          <div className="relative text-sm  text-gray-700 antialiased">
            ...
            <div className="mt-6 sm:mb-12 sm:mt-0">
              <div className="flex flex-col items-center sm:flex-row max-sm:ml-8">
                ...
                <div className="absolute left-1/2 max-sm:left-1 flex h-8 w-8 -translate-x-1/2 -translate-y-4 transform items-center justify-center rounded-full border-2 border-white dark:border-black bg-royalblue dark:bg-white text-white dark:text-black sm:translate-y-0">
                  1
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 sm:mb-12 sm:mt-0">
              <div className="flex flex-col items-center sm:flex-row max-sm:ml-8">
                ...
                <div className="absolute left-1/2 max-sm:left-1 flex h-8 w-8 -translate-x-1/2 -translate-y-4 transform items-center justify-center rounded-full border-2 border-white dark:border-black bg-[#5A56EB] dark:bg-white text-white dark:text-black sm:translate-y-0">
                  3
                </div>
              </div>
            </div>

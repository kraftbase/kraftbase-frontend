...
export default function Started({}: Props) {
  return (
    <div className="flex flex-row justify-between gap-x-6 my-40 max-w-[85%] max-2xl:max-w-[90%] max-sm:max-w-[95%] max-xl:flex-col max-xl:gap-y-8 overflow-hidden mx-auto text-black dark:text-white font-righteous">
      ...
      <div className="max-w-[741px] max-2xl:max-w-[641px] max-xl:max-w-full">
        ...
        <div className="flex flex-row justify-between gap-4 mt-4 max-sm:gap-2 max-sm:mt-2">
          ...
          <div className="flex flex-col justify-between gap-4 border-[9px] w-6/12 bg-royalblue px-6 py-6 rounded-[2rem] max-xl:p-8 max-sm:rounded-[2rem] max-sm:border-[5px] max-sm:p-4 max-xl:rounded-[4rem] max-sm:w-[60%]">

...
export default function Started({}: Props) {
  return (
    <div className="mx-auto my-40 flex max-w-[85%] flex-row justify-between gap-x-6 overflow-hidden font-righteous text-black dark:text-white max-2xl:max-w-[90%] max-xl:gap-y-8 max-md:flex-col max-sm:max-w-[95%]">
